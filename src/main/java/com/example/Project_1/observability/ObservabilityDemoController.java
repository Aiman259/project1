package com.example.Project_1.observability;
...
public class ObservabilityDemoController {
    ...
    public Map<String, Object> ping() {
        ...
        return Map.of("message", "Backend is running", "status", "OK");
    }

    @GetMapping("/slow")
    public Map<String, Object> slowEndpoint() throws InterruptedException {
        logger.info("Slow endpoint called");
        Thread.sleep(1500); // Simulasi kelewatan 1.5 saat
        logger.info("Slow endpoint completed");
        return Map.of("message", "Slow endpoint completed", "delay", "1500ms");
    }
